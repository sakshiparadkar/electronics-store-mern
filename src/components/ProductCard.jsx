...
export default function ProductCard({ product, addToCart }) {
  ...
  const handleAddToCart = event => {
    ...
    // Show popup — addToCart returns undefined but notify fires in App.jsx
    // We show popup optimistically; if already in cart, App notifies via toast
    setPopupOpen(true);
    setTimeout(() => setPopupOpen(false), 1800);
  };
