...
Call 9234665210, 7 AM–11 PM PST, daily. Quick solutions guaranteed.
              </Typography>
            </Stack>
          </Paper>
        </Grid>
        <Grid item xs={12} md={4} id="shipping">
          <Paper elevation={0} sx={{ p: 4, borderRadius: 4, height: '100%' }}>
            <Stack spacing={2}>
              ...
              <Typography variant="body2" color="text.secondary">
                Track your order in real time from the Orders dashboard. 
              </Typography>
            </Stack>
          </Paper>
        </Grid>
        <Grid item xs={12} md={4} id="privacy">
          <Paper elevation={0} sx={{ p: 4, borderRadius: 4, height: '100%' }}>
            <Stack spacing={2}>
              ...
              <Typography variant="body2" color="text.secondary">
               Your data is safe with us; see our full privacy policy.
              </Typography>
            </Stack>
          </Paper>
        </Grid>
